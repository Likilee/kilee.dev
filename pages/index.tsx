...
export default function Home() {
  ...
  const description =
    '데이터의 세계를 좋아하는, 문제 해결에 집중하는 개발자, hson의 블로그입니다.'
  return (
    <PageLayout>
      ...
      <div className="flex flex-col-reverse justify-between sm:flex-row items-start gap-4 sm:gap-6">
        <div className="w-full">
          <h1 className="mb-1 text-3xl font-bold tracking-tight md:text-5xl">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-yellow-200 dark:from-green-600 dark:to-blue-300">
              hson
            </span>
          </h1>
          <h2 className="mb-4">Data Engineer</h2>
